...
def get_args():
    ...
    parser.add_argument('-e', '--era',          required=True,      type=os.path.abspath)
...
def get_pileup(era, base_dir=baseDir): # code below taken from spark tnp
    ...
    hist    = TH1.from_numpy((pileup_ratio, pileup_edges))

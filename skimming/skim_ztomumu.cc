		        ...
		        long unsigned           nEntries )
{
    ...
    inputTreePtr->SetBranchStatus(      "_jetDeepJet_b",    1);
    //inputTreePtr->SetBranchStatus(    "_jetDeepCsv_bb",   1);
    inputTreePtr->SetBranchStatus(      "_jetDeepJet_bb",   1);
    ...
    Double_t _jetDeepJet_b[     nJets_max];         inputTreePtr->SetBranchAddress("_jetDeepJet_b",     _jetDeepJet_b);
    //Double_t _jetDeepCsv_bb[  nJets_max];         inputTreePtr->SetBranchAddress("_jetDeepCsv_bb",    _jetDeepCsv_bb);
    Double_t _jetDeepJet_bb[    nJets_max];         inputTreePtr->SetBranchAddress("_jetDeepJet_bb",    _jetDeepJet_bb);
    // start event loop
    ...
    for( long unsigned entry = 0; entry < nEntries; ++entry )
    {
        ...
        for(unsigned j = 0; j < _nJets; ++j)
        {
	        ...
	        double btagvalue                        = _jetDeepJet_b[j]+_jetDeepJet_bb[j];
